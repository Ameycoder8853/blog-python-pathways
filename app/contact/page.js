          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center">
              ...
              <p className="text-gray-600 dark:text-gray-50 text-lg mb-4">
                Got questions, feedback, or want to get in touch? We d love to hear from you. Whether you are a prospective member, a curious learner, or just want to say hello, reach out, and let s connect.
              </p>
